<template>
  <div class="q-pa-xl">
    <section>
      <div class="row justify-start">
        <div class="col-3 q-pr-xl text-right">
          <h5 class="q-pa-none q-my-none">Profile</h5>
        </div>
        <div class="col-1"></div>
        <div class="col-4">
    ...
    <section>
      <div class="row">
        <div class="col-3 q-pr-xl text-right">
          <h5 class="q-pa-none q-my-sm">Experience</h5>
        </div>
        <div class="col-1"></div>
        <div class="col-4">
          <h5 class="q-pa-none q-my-sm">Researcher at Universidad Autonoma de Madrid</h5>
        </div>
      </div>
    ...
    <section>
      <div class="row">
        <div class="col-3 q-pr-xl text-right">
          <h5 class="q-pa-none q-my-sm">Education</h5>
        </div>
        <div class="col-1"></div>
        <div class="col-4">
          <h5 class="q-pa-none q-my-sm">Universidad Autonoma de Madrid</h5>
        </div>
      </div>
    ...
    <section>
      <div class="row justify-start">
        <div class="col-3 q-pr-xl text-right">
          <h5 class="q-pa-none q-my-sm">Skills</h5>
        </div>
        <div class="col-1"></div>
        <div class="col-3">
    ...
    <section>
      <div class="row justify-start">
        <div class="col-3 q-pr-xl text-right">
          <h5 class="q-pa-none q-my-sm">Languages</h5>
        </div>
        <div class="col-1"></div>
        <div class="col-3">
          <ul class="q-my-sm" style="padding-left: 20px;">
    ...
    <section>
      <div class="row">
        <div class="col-3 q-pr-xl text-right">
          <h5 class="q-pa-none q-my-sm">Courses</h5>
        </div>
        <div class="col-1"></div>
        <div class="col-4"></div>
      </div>
      ...
      <div class="row justify-start">
        <div class="col-3 q-pr-xl text-right">Machine Learning</div>
        <div class="col-1"></div>
        <div class="col-4">
      ...
      <p></p>
      <div class="row justify-start">
        <div class="col-3 q-pr-xl text-right">Scala</div>
        <div class="col-1"></div>
        <div class="col-4">
          <ul class="q-my-none" style="padding-left: 20px;">
      ...
      <div class="row justify-start">
        <div class="col-3 q-pr-xl text-right">SQL</div>
        <div class="col-1"></div>
        <div class="col-4">
          <ul class="q-my-none" style="padding-left: 20px;">
      ...
      <div class="row justify-start">
        <div class="col-3 q-pr-xl text-right">NLP</div>
        <div class="col-1"></div>
        <div class="col-4">
          <ul class="q-my-none" style="padding-left: 20px;">
...
<section>
      <div class="row justify-start">
        <div class="col-3 q-pr-xl text-right">
          <h5 class="q-pa-none q-my-sm">Conferences</h5>
        </div>
        <div class="col-1"></div>
        <div class="col-3">
          <ul class="q-my-sm" style="padding-left: 20px;">
